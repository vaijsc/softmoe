...
from soft_moe_ord import SoftMoELayerWrapper
...
def soft_moe_vit_tiny(
    num_experts=128, slots_per_expert=5, moe_layer_index=6, **kwargs
) -> SoftMoEVisionTransformer:
    kwargs.pop('pretrained', None)  # Remove 'pretrained' if present
    kwargs.pop('pretrained_cfg', None)  # Remove 'pretrained' if present
    kwargs.pop('pretrained_cfg_overlay', None)  # Remove 'pretrained' if present
